...
function App() {
  ...
  // --- KOMPONEN DIVIDER (Updated sesuai Request) ---
      ...
      <div className="relative z-10 flex min-h-screen w-full flex-col overflow-x-hidden">
        ...
        <section className="relative w-full h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url("${heroImage}")` }}>
            ...
            {/* UPDATED: Gradient Fade yang lebih halus menyatu dengan background section bawah */}
        ...
        <section className="px-4 lg:px-20 py-16 relative transition-colors duration-500" id="menu">
          <div className="container mx-auto max-w-[1200px]">
            ...
            {/* Section Header (UPDATED Style Divider) */}
            ...
            {/* ITEM 2: ES POTENG (Updated style mirip screenshot) */}
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-gold-aged/20 pt-8">
                  {[
                    ...
                    { val: '50+', label: 'Pesanan' },
                    { val: '4.9', label: 'Rating' },
                    { val: '24h', label: 'Layanan' },
                  ].map((stat, idx) => (
                    <div key={idx}>
                      <div className="text-3xl font-black text-forest-deep dark:text-gold-aged font-display">{stat.val}</div>
                      <div className="text-xs font-bold text-secondary/60 dark:text-gray-500 uppercase tracking-widest mt-1 font-body">{stat.label}</div>
                    </div>
                  ))}
                </div>
              </div>
